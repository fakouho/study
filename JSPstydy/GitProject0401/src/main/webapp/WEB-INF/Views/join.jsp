...
<body>
									...
									<div class="col-12">
										<div class="form-floating">
											<input type="text" class="form-control bg-light border-0"
												...
												value="${nickName}"> <label for="email">닉네임</label>
										</div>
									</div>
								</div>
							</div>
							...
							<div>
								...
								<div class="row g-3">
									<div class="col-12">
										<div class="form-floating">
											<input type="text" class="form-control bg-light border-0"
												id="name" placeholder="" name="mem_name" value="${name}"
									...
									<div class="col-12">
										<div class="form-floating" id="divBirthday">
											<input type="text"
												...
												id="datepicker" placeholder="생년월일" maxlength="10"
	...
	<script>
        // DOM이 준비되면 Flatpickr를 초기화합니다.
        document.addEventListener('DOMContentLoaded', function() {
            flatpickr("#datepicker", {
                dateFormat: "Y-m-d", // 날짜 형식 설정
                locale: "ko", // 한국어로 설정
                maxDate: new Date() // 현재 날짜를 최대 선택 가능한 날짜로 설정
            });
        });
    </script>
</body>
