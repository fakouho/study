      ...
      <div class="panel shadow1">
         <form class="login-form" action="Join.do" method="post">
            ...
            <fieldset id="login-fieldset">
               ...
               <input class="login animated fadeInUp animate3" class="loginfont"
                  name="mem_phone" type="text" required placeholder="연락처" value="">
               <input class="login animated fadeInUp animate3" class="loginfont"
                  name="mem_birthdate" type="text" required placeholder="생년월일"
                  value=""> <input class="login animated fadeInUp animate3"
                  class="loginfont" name="mem_addr" type="text" required
                  placeholder="주소" value=""> <input
               ...
               <input class="login animated fadeInUp animate3" class="loginfont"
                  name="mem_gender" type="text" required placeholder="성별" value="">
               <input class="login animated fadeInUp animate3" class="loginfont"
                  name="height" type="text" required placeholder="키" value="">
               <input class="login animated fadeInUp animate3" class="loginfont"
                  name="weight" type="text" required placeholder="체중" value="">
