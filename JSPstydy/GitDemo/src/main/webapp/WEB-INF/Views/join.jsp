...
<body>
			...
			<form class="login-form" action="Join.do" method="post">
				<div class="panel-switch animated fadeIn">
					<button type="button" id="sign_up" class="active-button"
						onclick="location.href='http://localhost:8080/GitProject/fitlogin2.do'">
						Sign Up
					</button>
				...
				<fieldset id="login-fieldset">
					...
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="mem_name" type="text" required placeholder="name" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="mem_phone" type="text" required placeholder="000-0000-000" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="mem_birthdate" type="text" required placeholder="1997-07-19"
						value=""> <input class="login animated fadeInUp animate3"
						class="loginfont" name="mem_addr" type="text" required
						placeholder="address" value=""> <input
						class="login animated fadeInUp animate3" class="loginfont"
						name="mem_email" type="text" required placeholder="email" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="mem_nick" type="text" required placeholder="nicname" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="mem_gender" type="text" required placeholder="F/M" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="height" type="text" required placeholder="height" value="">
					<input class="login animated fadeInUp animate3" class="loginfont"
						name="weight" type="text" required placeholder="weight" value="">
				</fieldset>
	...
	<div>
		<form action="Login.do" method="post">
			<input type="text" name="mem_id" placeholder="아이디입력">
			<input type="password" name="mem_pw" placeholder="비밀번호입력">
