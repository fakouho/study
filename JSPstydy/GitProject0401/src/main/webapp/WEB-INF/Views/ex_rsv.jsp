												...
												<div class="custom-block-info">
													...
													<div class="profile-block d-flex">
														...
														<div>
															...
															<p id="get_trn" class="rsvFont"></p>
															<p id="trn_phone" class="rsvFont"></p>
															<p id="trn_info" class="rsvFont"></p>
															<p id="trn_career" class="rsvFont"></p>
												...
												<div class="custom-block-info">
													...
													<div class="profile-block d-flex">
														...
														<div>
															...
															<p id="center_name" class="rsvFont"></p>
															<p id="center_tel" class="rsvFont"></p>
															<p id="center_addr" class="rsvFont"></p>
															<p id="vc_price" class="rsvFont"></p>
