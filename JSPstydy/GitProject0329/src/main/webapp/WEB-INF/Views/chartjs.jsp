						...
						<div class="col-lg-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body" id="diet">
									...
									<a href="#" id="dietLink">
										<h4 class="card-title" id="dietTitle" class="charimg">Title</h4> 
										<img src="https://th.bing.com/th/id/OIP.5HMeJ_1Xc5mo6LUkycOEpAHaEK?w=333&h=187&c=7&r=0&o=5&pid=1.7"
										class ="giim" >
									</a>
						...
						<div class="col-lg-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body" id="news">
									<h2>News</h2>
									<a href="#" id="newsLink">
										<h4 class="card-title" id="newsTitle" class="charimg">Title</h4> 
										<img src=""alt="News Image" id="newsImage">
									</a>
									<canvas id="barChart" style="height: 250px;"></canvas>
								</div>
							</div>
							...
							<div class="card">
								<div class="card-body" id="routine">
									...
									<a href="#" id="routineLink">
										<h4 class="card-title" id="routineTitle" class="charimg">Title</h4> <img
