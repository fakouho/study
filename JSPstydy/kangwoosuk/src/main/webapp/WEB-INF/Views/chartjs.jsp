							...
							<div class="card">
								<div class="card-body" id="diet">
									...
									<a href="#" id="dietLink">
										...
										<div class="charimg">
										<img alt="Diet Image" id="dietImage"
										src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyNDAzMDZfMTI5%2FMDAxNzA5NzMyMjIxMTgw.0p1HBH9xc0UmVtOrpVwpc1u7HslIssbGpiDtwCmiVXIg.w92PHKLWwbww2awQ6yKo5McmFs2GDtPyNbbVPX10Ugcg.PNG%2F5.png&type=a340" >
										</div>
									</a>
								</div>
							</div>
						...
						<div class="col-lg-4 grid-margin stretch-card">
							<div class="card">
								<div class="card-body" id="news">
									<h2>News</h2>
									<a href="#" id="newsLink">
										<h4 class="card-title" id="newsTitle">우리아리짱아리 귀염아리 깜찍아리 사랑해</h4> 
										<div class="charimg">
										<img  alt="News Image" id="newsImage"
										src="https://search.pstatic.net/common/?src=http%3A%2F%2Fblogfiles.naver.net%2FMjAyMzExMjBfNTMg%2FMDAxNzAwNDY5NTM5NTIy.2XsH9wgFebQKy85b1NKp6Xu8N5JA0WIHfIJ-5Y5Cz1gg.hGeHBif8Kq-VXRLp1r0UcAuM9tA54MKyHN11zuoiyUkg.PNG.marqq%2Fimage.png&type=a340">
										</div>
									</a>
								</div>
							</div>
